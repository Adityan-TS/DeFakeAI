...
def upload():
    ...
    # Clear previous deepfake frames to save memory
    clear_deepfake_frames()
...
def clear_deepfake_frames():
    """
    Clears all files in the 'deepfake_frames' folder to free memory.
    """
